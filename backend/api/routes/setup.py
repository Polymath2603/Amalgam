...
PROVIDER_CATALOG = [
    ...
    {"id": "anthropic",        "name": "Anthropic (Claude)",           "has_free_tier": False, "needs_api_key: "REDACTED"],              "api_key_hint": "starts with sk-ant- (108 chars)",                       "base_url": "https://api.anthropic.com/v1",                     "base_url_constant": True},
    ...
    {"id": "groq",             "name": "Groq",                         "has_free_tier": True,  "needs_api_key: "REDACTED", "llama-3.1-8b-instant", "llama-3.3-70b-versatile"], "api_key_hint": "starts with gsk_ (56 chars)",              "base_url": "https://api.groq.com/openai/v1",                   "base_url_constant": True},
