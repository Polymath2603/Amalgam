...
COMMANDS = [
    ...
    {"name": "provider",   "desc": "Switch AI provider (gemini, ollama, openrouter…)"},
    ...
    {"name": "mcp",        "desc": "Manage MCP tool servers (/mcp list, connect, disconnect)"},
    {"name": "company",    "desc": "AI Company plugin: on | off | auto | status | run <task>"},
    {"name": "plan",       "desc": "Manage multi-step plans (/plan create|list|run|cancel)"},
    {"name": "direct",     "desc": "Toggle direct mode (plain agent, skips planning/reflection layers)"},
    {"name": "vault",      "desc": "Search vault notes (/vault <query>)"},
]
